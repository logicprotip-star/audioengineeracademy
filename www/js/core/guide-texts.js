...
export const MODE_OPTIONS_TEXTS = {
  ...
  // G335 (OLCUM-TONAL-KAYNAK-19-08) — kaynak listesi "Davul Döngüsü" ya da
  // yükleme'den çıkıp Hi-Hat/Snare/Vokal/gitarlara genişledi, metin buna göre
  // güncellendi (tek tek saymak yerine "birden fazla kaynak" — liste büyümeye
  // devam edebilir, tek tek isim vermek metni kırılgan yapardı).
  "tonal-denge": "Kaynağı Davul Döngüsü, Hi-Hat, Snare, Vokal ve gitar kayıtları arasında değiştirebilir, kendi dosyanı da yükleyebilirsin. 'A/B Test'le düzeltmeden önceki/sonraki sesi karşılaştırabilirsin. Bilemezsen 'Atla'ya dokun. Durdur'a basıp sonra cevap verirsen geri bildirim ekranda kalır, sen geçene kadar kapanmaz.",
